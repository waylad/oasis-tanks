...
export interface OasistanksInterface extends utils.Interface {
  functions: {
    ...
    "mintTank(address)": FunctionFragment;
    ...
    "upgradeTank(uint256,string)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "_tokenToTankCode",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "mintTank", values: [string]): string;
  ...
  decodeFunctionResult(functionFragment: "mintTank", data: BytesLike): Result;
...
export interface Oasistanks extends BaseContract {
  ...
  callStatic: {
    ...
    mintTank(owner: string, overrides?: CallOverrides): Promise<BigNumber>;
